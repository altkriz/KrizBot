var BardAPIKey = "YQhCrQGoPqvEzeAX0VYsxDN6F61lnWCHlZWUNZBLt0wmYrjwjLYqjfCvGSWUYR_ALT8OlA.";//Follow Quickstart guide for API key
...
function typ(str,idi){
 //Typing animation
  var string = str;
var str = string.split("");
var el = document.getElementById(idi);
(function animate() {
